...
namespace ExpertReviewIndex.Data
{
    public class ExpertReview
    {
        ...
        private float _UserAverageRating;

        public float UserAverageRating
        {
            get { return _UserAverageRating; }
            set { _UserAverageRating = value; }
        }

        private int _UserVotes;

        public int UserVotes
        {
            get { return _UserVotes; }
