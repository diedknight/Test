...
namespace ImportAttrs.Data
{
    ...
    //,[DR_AttValue_Changed]
    //,[Status]
    public class AttributeUnmatchedReport
    {
        ...
        public AttributeUnmatchedReport(int rId, int cId, int pId, int attType, int attTitleId, string pm_AttName, string dr_AttName, string dr_AttValue_Orignal, string dr_AttValue_Changed, bool status)
        {
            RID = rId;
            CID = cId;
            PID = pId;
