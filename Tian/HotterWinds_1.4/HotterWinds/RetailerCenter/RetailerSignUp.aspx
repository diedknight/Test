<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="RetailerSignUp.aspx.cs" Inherits="HotterWinds.RetailerCenter.RetailerSignUp" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        ...
        <div class="contentTopDiv">
            ...
            <div class="signUpDivLeft">

                <div class="page-header rsu">
                    <h1 class="productInfo"><%=Resources.Resource.TextString_RetailerSignUp %></h1>
                </div>

                <div class="retailerSignUpInfo">
                    <%=Resources.Resource.TextString_SignUpCon.Replace("PriceMe","Hotter Winds") %>
                </div>
                <table class="signUpTable">
                    <tbody>
                        <tr>
                            <td>
                                <asp:ValidationSummary ID="ValidationSummary1" runat="server" ValidationGroup="step1" CssClass="alert alert-danger" />
                                <uc5:ResultMessage ID="ResultMessage1" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="cf-style-1">
                                <label><span style="color: #f03">*</span><strong><%=Resources.Resource.TextString_RetailerName %>:</strong></label></td>
                        </tr>
                        <tr>
                            <td>
                                <asp:TextBox ID="txtRName" runat="server" ValidationGroup="step1" class="input form-control le-input" />
                                <asp:RequiredFieldValidator ID="frvRName" runat="server" ControlToValidate="txtRName"
                                    Display="None" ErrorMessage="Please enter Retailer name" ValidationGroup="step1" /></td>
                        </tr>
                        <tr>
                            <td class="cf-style-1">
                                <label><span style="color: #f03">*</span><strong><%=Resources.Resource.TextString_WebSiteURL %></strong></label></td>
                        </tr>
                        <tr>
                            <td>
                                <asp:TextBox ID="txtWUrl" runat="server" Text="http://www." ValidationGroup="step1" class="input form-control le-input" type="url" />
                                <asp:RequiredFieldValidator ID="rfvWUrl" runat="server" ControlToValidate="txtWUrl"
                                    Display="None" ErrorMessage="Please enter Web Site URL" ValidationGroup="step1" />
                                <asp:RegularExpressionValidator runat="server" ID="revWUrl" ControlToValidate="txtWUrl"
                                    Display="None" ErrorMessage="Please enter a correct format Web Site URL" ValidationGroup="step1"
                                    ValidationExpression="http(s)?://([\w-]+\.)+[\w-]+(/[\w- ./?%&amp;=]*)?" />
                            </td>
                        </tr>
                        <tr>
                            <td class="cf-style-1">
                                <label><span style="color: #f03">*</span><strong><%=Resources.Resource.TextString_ContactName %></strong></label></td>
                        </tr>
                        <tr>
                            <td>
                                <asp:TextBox ID="txtContactName" runat="server" ValidationGroup="step1" class="input form-control le-input" />
                                <asp:RequiredFieldValidator ID="rfvCName" runat="server" ControlToValidate="txtContactName"
                                    Display="None" ErrorMessage="Please enter contact name" ValidationGroup="step1" /></td>
                        </tr>
                        <tr>
                            <td class="cf-style-1">
                                <label><span style="color: #f03">*</span><strong><%=Resources.Resource.TextString_EmailAddress %>:</strong></label></td>
                        </tr>
                        <tr>
                            <td>
                                <asp:TextBox ID="txtEAddress" runat="server" ValidationGroup="step1" class="input form-control le-input" type="email" />
                                <asp:RequiredFieldValidator ID="rfvEamil" runat="server" ControlToValidate="txtEAddress"
                                    Display="None" ErrorMessage="Please enter Email Address" ValidationGroup="step1" />
                                <asp:RegularExpressionValidator runat="server" ID="cvEmail" ControlToValidate="txtEAddress"
                                    Display="None" ErrorMessage="Please enter a correct Email Address" ValidationGroup="step1"
                        ...
                        <tr>
                            <td class="cf-style-1">
                                <label><span style="color: #f03">*</span><strong><%=Resources.Resource.RetailerInfo_StoreInfo_GSTNumber %>:</strong></label></td>
                        </tr>
                        <tr>
                            <td>
                                <asp:TextBox ID="txtGSTNumber" runat="server" Text="" ValidationGroup="step1" class="input form-control le-input" type="number" />
                                <asp:RequiredFieldValidator ID="rfvGst" runat="server" ControlToValidate="txtGSTNumber"
                                    Display="None" ErrorMessage="Please enter the GST number" ValidationGroup="step1" />
                            </td>
                        </tr>
                        <%} %>
                        <tr>
                            <td style="padding-top: 10px; text-align: left;">
                                <asp:LinkButton ID="btnSetp1" runat="server" OnClick="btnSetp1_Click" ValidationGroup="step1" class="btn btn-info"><%=Resources.Resource.TextString_Sign_Up%> <span class="glyphicon glyphicon-arrow-right"></span></asp:LinkButton></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="signUpDivRight">
                ...
                <ul class="list-unstyled list-benefits">
                    <li><i class="glyphicon glyphicon-ok pm-button-blue"></i> Drive high quality traffic to your site.</li>
