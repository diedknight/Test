                            ...
                            <ul>
                                ...
                                <li data-transition='random' data-slotamount='7' data-masterspeed='1000' data-thumb='https://s3.pricemestatic.com/Images/HotterWindsVersion/slide-img1-150x150.jpg'>
                                    ...
                                    <div class="info">
                                        ...
                                        <div class='tp-caption LargeTitle sfl  tp-resizeme ' data-endspeed='500' data-speed='500' data-start='1300' data-easing='Linear.easeNone' data-splitin='none' data-splitout='none' data-elementdelay='0.1' data-endelementdelay='0.1' style='z-index: 3; max-width: auto; max-height: auto; white-space: nowrap;'><span>FOR ADVENTURE</span> </div>
                                ...
                                <li data-transition='random' data-slotamount='7' data-masterspeed='1000' data-thumb='https://s3.pricemestatic.com/Images/HotterWindsVersion/slide-img2-150x150.jpg'>
                                    ...
                                    <div class="info">
                                        ...
                                        <div class='tp-caption LargeTitle sfl  tp-resizeme ' data-endspeed='500' data-speed='500' data-start='1300' data-easing='Linear.easeNone' data-splitin='none' data-splitout='none' data-elementdelay='0.1' data-endelementdelay='0.1' style='z-index: 3; max-width: auto; max-height: auto; white-space: nowrap;'>FOR TRAVEL</div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-9 col-sm-push-3">
                    ...
                    <div class="promotion-banner">
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-sm-5">
                                <a href="https://hotterwinds.co.nz/" title=" Banner 1">
                            ...
                            <div class="col-lg-7 col-sm-7">
                                <a href="https://hotterwinds.co.nz/" title=" Banner 2">
                                                            ...
                                                            <div class="item-info">
                                                                <div class="info-inner">
                                                                    ...
                                                                    <div class="item-content">
                                                                        ...
                                                                        <div class="action">
                                                                            <a target="_blank" class="button btn-cart" href="<%=p.PurchaseUrl%>" onclick="dataLayer.push({'transactionId': '<%=Guid.NewGuid() %>','transactionProducts': [{ 'name': '<%=p.RetailerProductName %>', 'sku': '<%=p.RetailerId %>','category': <%=p.CategoryId %>, 'price': <%=p.Price %>, 'quantity': 1, 'dimension1' : '<%=p.RetailerId %>'}],'event': 'pmco_trans'});">
                    ...
                    <%if (Model.BestSellerProducts.Count != 0) %>
                    <%{ %>
                ...
                <aside class="col-left sidebar col-sm-3 col-xs-12 col-sm-pull-9">
                                    ...
                                    <div class="item-info">
                                        <div class="info-inner">
                                            ...
                                            <div class="item-content">
                                                ...
                                                <div class="action">
                                                    <a class="single_add_to_cart_button add_to_cart_button button btn-cart" target="_blank" href="<%=Model.HotDeal.PurchaseUrl %>" onclick="dataLayer.push({'transactionId': '<%=Guid.NewGuid() %>','transactionProducts': [{ 'name': '<%=Model.HotDeal.RetailerProductName %>', 'sku': '<%=Model.HotDeal.RetailerId %>','category': <%=Model.HotDeal.CategoryId %>, 'price': <%=Model.HotDeal.Price %>, 'quantity': 1, 'dimension1' : '<%=Model.HotDeal.RetailerId %>'}],'event': 'pmco_trans'});">
                                                        <span>Visit Shop</span>
                                                    </a>
                    ...
                    <div class="featured-add-box">
                        <div class="featured-add-inner">
                            ...
                            <a href="https://hotterwinds.co.nz/" title="bottom Banner 1">
