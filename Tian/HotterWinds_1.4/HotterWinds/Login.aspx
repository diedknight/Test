<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="HotterWinds.Login" %>
                            ...
                            <div class="static-contain">
                                ...
                                <div class="page-content">
                                    <div class="woocommerce">
                                        ...
                                        <asp:Literal ID="ltlErrorMsg" runat="server"></asp:Literal>
                                        ...
                                        <div class="col2-set" id="customer_login">
                                            <div class="col-1">
                                                ...
                                                <p class="form-row form-row-wide">
                                                    ...
                                                    <asp:TextBox TextMode="Password" ID="txtPassword" runat="server" CssClass="input-text"></asp:TextBox>
                                                </p>


                                                <p class="form-row">
                                                    <%--<input type="hidden" id="_wpnonce" name="_wpnonce" value="5d801cfeca">
                                                    <input type="hidden" name="_wp_http_referer" value="/linea/my-account/">--%>
                                                ...
                                                <%--<p class="lost_password">
                                                    <a href="http://wordpress.magikthemes.com/linea/my-account/lost-password/">Forget password?</a>
                                                </p>--%>
                                            </div>
                                            ...
                                            <div class="col-2">
                                                ...
                                                <p class="form-row form-row-wide">
                                                    ...
                                                    <asp:TextBox ID="txtRegEmail" runat="server" CssClass="input-text"></asp:TextBox>
                                                </p>
                                                ...
                                                <p class="form-row form-row-wide">
                                                    ...
                                                    <asp:TextBox TextMode="Password" ID="txtRegPassword" runat="server" CssClass="input-text"></asp:TextBox>
                                                </p>
                                                ...
                                                <p class="form-row">
                                                    <%--<input type="hidden" id="_wpnonce" name="_wpnonce" value="1c73e73883">
                                                    <input type="hidden" name="_wp_http_referer" value="/linea/my-account/">--%>
