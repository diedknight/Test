            ...
            <div class="sitemap">
                ...
                <div class="ctcdiv">
                    <div class="ctcdivhover">
                        <div class="ctcicon">
                            <a href="<%=url %>">
                                <%if (string.IsNullOrEmpty(imgicon))
                                    { %>
                                <img src="<%=/*Resources.Resource.ImageWebsite +*/ imgurl %>" alt="<%=subc.CategoryName %>" width="150" height="150" onerror="onImgError_catalog(this)" /><%}
                                else
                                { %>
                        ...
                        <%List<PriceMeCache.CategoryCache> subCatas = CategoryController.GetNextLevelSubCategories(subc.CategoryID, WebConfig.CountryId).OrderBy(item => item.ListOrder).ToList();
                            if (subCatas.Count > 0)
                            { %>
                        <% 
                            bool ismore = false;
            ...
            <div class="sitemapphone">
                ...
                <div class="line" onclick="openlink('<%=url%>');">
                    <div class="icon">
                        <%if (string.IsNullOrEmpty(imgicon))
                            { %>
                        <img src="<%=/*Resources.Resource.ImageWebsite +*/ imgurl %>" alt="<%=subc.CategoryName %>" width="50" height="50" onerror="onImgError(this)" /><%}
                                                                                                                                                                            else
                                                                                                                                                                            { %>
                        <%=imgicon %>
                        <%} %>
                    ...
                    <div class="name">
                        <div class="vertical"><a href="<%=url %>"><%=subc.CategoryName %></a></div>
                    </div>
                    <div class="link">
                        <div class="vertical"><a href="<%=url %>"><span class="glyphicon glyphicon-chevron-right iconGray"></span></a></div>
                    </div>
                </div>
                <%} %>
                <%if (Category.CategoryID == 355 && WebConfig.CountryId == 3)
                ...
                <div class="line" onclick="openlink('https://www.priceme.co.nz/plans/mobile-plans');">
                    ...
                    <div class="name">
                        <div class="vertical"><a href="https://www.priceme.co.nz/plans/mobile-plans">Mobile Plans</a></div>
                    </div>
                    <div class="link">
                        <div class="vertical"><a href="https://www.priceme.co.nz/plans/mobile-plans"><span class="glyphicon glyphicon-chevron-right iconGray"></span></a></div>
                    </div>
                </div>
                <%} %>
...
";
                ...
                <div class="line" onclick="openlink('<%=dealsUrl%>');">
                    ...
                    <div class="name">
                        <div class="vertical"><a href="<%=dealsUrl%>"><%=dealsLinkText%></a></div>
                    </div>
                    <div class="link">
                        <div class="vertical"><a href="<%=dealsUrl%>"><span class="glyphicon glyphicon-chevron-right iconGray"></span></a></div>
                    </div>
                </div>
