...
<style type="text/css">
    #fCountATag {
        ...
        #fCountATag:hover {
            background-color: #06b24f;
        }

    #newfilter .nbValues i.checked {
        background-color: #1fc0a0 !important;
    }

    #newfilter .nbValues > div:hover > .checkSpan, #newfilter .nbValues .group > div:hover > .checkSpan, #newfilter .nbValues .group li:hover > .checkSpan {
        background-color: #1fc0a0 !important;
    }

    #newfilter .nbValues .moreValues > div:hover > .checkSpan, #newfilter .nbValues .moreValues li:hover > .checkSpan {
        background-color: #1fc0a0 !important;
    }

    #newfilter .nbValues > div:hover > .name, #newfilter .nbValues .group > div:hover > .name, #newfilter .nbValues .group li:hover > .name, #newfilter .nbValues .moreValues > div:hover > .name {
        color: #1fc0a0;
    }

    #newfilter .nbValues i.checked + .name {
        color: #1fc0a0;
    }
...
<aside>
    ...
    <div id="newfilter">
        ...
        <h3 class="filterTitle"><%=Resources.Resource.TextString_Filters %></h3>
        <div id="filterHeader">
            <span id="productCountInfo">
                <label><%=CurrentProductCount.ToString("N0") %></label>
                / <%=TotalProductCount.ToString("N0") %> <%=Resources.Resource.TextString_Products %></span>
