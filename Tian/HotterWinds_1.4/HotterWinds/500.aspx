<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="500.aspx.cs" Inherits="HotterWinds._500" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        ...
        <div class="std">
            <div class="page-not-found wow bounceInRight animated animated" style="visibility: visible;">
                <h2 style="font-size:50px;">Error : Internal server error</h2>

                <h3><img src="/linea/wp-content/themes/linea/images/signal.png" alt="404! Page Not Found">
                         An error has occured on the site.This error has been reported automatically to Hotterwinds staff.Please click back to return to the previous page or return to Home page.</h3>

                <div><a href="/" type="button" class="btn-home"><span>Back To Home</span></a></div>
            </div>
        </div>
    </div>
</div>
