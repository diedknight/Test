...
//                }
//                urlString = Utility.FilterIllegalChar(urlString.Replace("/", "-"));
//                urlString = HttpUtility.UrlEncode(urlString);
//                if (urlString.Length > 100)
//                {
//                    return urlString.Substring(0, 100);
//                }
//            }
//            return "";
//        }

//        public string ToDescription(Commerce.Common.Category category)
//        {
//            this.Sort();
//            string desString = "";
//            if (this.Count > 2)
