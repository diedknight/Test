...
namespace ExpatSoftware.Helpers.ABTesting.Controls
{
	[ControlBuilderAttribute(typeof(ABTestBuilder)), ParseChildren(false)]
	public class Test : WebControl, INamingContainer
	{
		...
		protected override void Render(HtmlTextWriter writer)
		{
			...
			ABTest test = FairlyCertain.GetOrCreateTest(TestName, Controls);
