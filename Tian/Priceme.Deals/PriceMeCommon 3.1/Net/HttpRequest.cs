...
namespace PriceMeCommon.Net {
    public class HttpRequest {
        ...
        /// <returns></returns>
        public static string GetCtx( string url, string method , Encoding encode, int timeout ) {
            WebHeaderCollection repheaders;
            CookieCollection cookies;
        ...
        public static string GetCtx(string url, string method, Encoding encode, Dictionary<string, string> headers, string origDatas) {
        ...
        public static string GetCtx(string url, string method, Encoding encode, int? timeout, Dictionary<string, string> headers, Dictionary<string, string> datas, string origDatas, out WebHeaderCollection responseHeader, out CookieCollection cookies) {
            cookies = null;
            responseHeader = null;
