<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ThanksForRetailerSignUp.aspx.cs" Inherits="HotterWinds.RetailerCenter.ThanksForRetailerSignUp" %>

<%@ Register Src="../Modules/RetailerCenterNavigation.ascx" TagName="RetailerCenterNavigation" TagPrefix="uc1" %>
<%@ Register Src="../Modules/MobileSite.ascx" TagName="MobileSite" TagPrefix="uc2" %>
<%@ Register Src="~/Modules/Hitwise.ascx" TagName="Hitwise" TagPrefix="uc7" %>
<%@ Register Src="~/Modules/ResultMessage.ascx" TagName="ResultMessage" TagPrefix="uc5" %>
<%@ Register Src="~/Modules/AlexaTrafficRanker.ascx" TagName="AlexaTrafficRanker" TagPrefix="uc3" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <style type="text/css">
        ...
        @media (min-width: 360px),(max-width:360px) {
            ...
            .signUpTable input, .signUpTable td, .signUpTable select, .btn-info {
                width: 100%;
            }
    ...
    <div class="container">
        ...
        <div class="page-header">
            <h1 class="productInfo">
                <img style="vertical-align: middle" src="<%=(Resources.Resource.ImageWebsite + "/images/retailers.gif") %>" width="24" height="24" />
                <%=Resources.Resource.TextString_ThanksForSigningUp %></h1>
        </div>

        <div class="contentTopDiv">

            <div class="signUpDivLeft">
                <div class="retailerSignUpInfo"><%=Resources.Resource.TextString_ThanksForSigningUp_Info %>:</div>
                <table class="signUpTable">
                    <tbody>
                        <tr>
                            <td class="cf-style-1">
                                <label><strong><%=Resources.Resource.TextString_JobFunction %>:</strong></label></td>
                        </tr>
                        <tr>
                            <td class="leftText">
                                <asp:DropDownList ID="ddlJobFunction" runat="server" AppendDataBoundItems="true" ValidationGroup="step2" CssClass="input form-control le-input">
                        ...
                        <tr>
                            <td class="cf-style-1">
                                <label><strong>eCommerce platform:</strong></label></td>
                        </tr>
                        <tr>
                            <td class="leftText">
                                <asp:DropDownList ID="ddlPlatforms" runat="server" AppendDataBoundItems="true" ValidationGroup="step2" CssClass="input form-control le-input">
                                    <asp:ListItem Text="Please select" Value="-1" />
                                </asp:DropDownList>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="rightText"><span>&nbsp;&nbsp;<strong><%=Resources.Resource.TextString_FeedURL %>:</strong><br />
                                <br />
                            </span></td>
                        </tr>
                        <tr>
                            <td class="leftText">
                                <asp:TextBox ID="txtFUrl" runat="server" ValidationGroup="step2" CssClass="input form-control" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>(<%=Resources.Resource.TextString_ThanksForRetailerSignUp_Info %>)</label></td>
                        </tr>
                        <%if (PriceMe.WebConfig.CountryId != 3)
                            { %>
                        <tr>
                            <td class="cf-style-1">
                                <label><span style="color: #f03"></span><strong><%=Resources.Resource.RetailerInfo_StoreInfo_GSTNumber %>:</strong></label>
                            </td>                            
                        </tr>
                        <tr>
                            <td class="leftText">
                                <asp:TextBox ID="txtGSTNumber" runat="server" Text="" ValidationGroup="step2" class="input form-control le-input" />
                        ...
                        <tr>
                            <td style="padding-top: 10px;">
                                <asp:LinkButton ID="btnStep2" runat="server" OnClick="btnStep2_Click" ValidationGroup="vgEmail" class="btn btn-info">Apply <span class="glyphicon glyphicon-arrow-right"></span></asp:LinkButton>
                            </td>
                        </tr>
                    </tbody>
                </table>
