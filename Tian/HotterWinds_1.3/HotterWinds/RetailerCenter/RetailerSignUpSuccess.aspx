<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="RetailerSignUpSuccess.aspx.cs" Inherits="HotterWinds.RetailerCenter.RetailerSignUpSuccess" %>
                        ...
                        <td>
                            ...
                            <div>
                                ...
                                <h1 class="productInfo">
                                    ...
                                    <%=Resources.Resource.TextString_SignUpSuccessful %></h1>
                                <br />
                            </div>
                            <div class="retailerSignUpInfo">
                                <%=Resources.Resource.TextString_RetailerSignUp_Info %>
                            </div>
                            <br />
                            <br />
                            <asp:LinkButton ID="btnContinue" runat="server" OnClick="btnContinue_Click" class="btn btn-success"><%=Resources.Resource.TextString_Continue%> <span class="glyphicon glyphicon-arrow-right"></span></asp:LinkButton>
                            <br />
                            <br />
                            <br />
                        </td>
