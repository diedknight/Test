...
{
    static string connectionStr = MultiCountryController.CommonConnectionStringSettings_Static.ConnectionString;
    ...
    public static void RetailerReviewInsert(CSK_Store_RetailerReview rr, int reviewstatus, int basicReview, string email)
    {
        ...
        {
            LogController.WriteLog("Retailer review error: " + ex.Message + ex.StackTrace);
        }
    }
