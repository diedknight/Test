...
namespace HotterWinds.HWUtility
{
    public class UrlParam
    {
        ...
        public UrlParam(HttpRequestBase request)
        {
        ...
        public UrlParam(Uri url) : this(url.ToString())
        { }
        ...
        {
            return this.url.GetBaseUrl() + this.url.AbsolutePath.ToString() + GetUrlParams();
        }
    }
}