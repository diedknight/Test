...
namespace PriceMeDBA {
    public partial class CSK_Store_Retailer: IActiveRecord{
        ...
        //保存评论到CSK_Store_RetailerReview 和 CSK_Store_RetailerRating
        //发送邮件提醒admin 有新的retaier 评论，
        //评论被admin通过后，才更新CSK_Store_RetailerVotesSum表
        //页面上的评论数量来自CSK_Store_RetailerVotesSum.RetailerTotalRatingVotes
        ...
        public int ReviewsCount
        {
            get
            {
                return RetailerTotalRatingVotes ?? 1;//Reviews.Count;
            }
