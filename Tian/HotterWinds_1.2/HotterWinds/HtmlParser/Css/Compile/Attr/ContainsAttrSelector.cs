...
{
    public class ContainsAttrSelector:AbsCompile
    {
        ...
        public override HtmlNodeList Run(HtmlNodeList nodeList, Tokens<Syntax.AbsSyntax> tokens)
        {
            ...
            return nodeList.Filter(item => item.GetAttr(syntax.AttrName) != null && item.GetAttr(syntax.AttrName).Contains(syntax.Value));
        }
