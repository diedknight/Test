<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="HotterWinds.Product" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link rel='stylesheet' id='woocommerce_prettyPhoto_css-css' href='/linea/wp-content/plugins/woocommerce/assets/css/prettyPhoto.css?ver=4.4.1' type='text/css' media='all' />
...
/* ]]> */
    ...
    <link rel='prev' title='Today Fashion Casual Sleeveless Solid Women&#8217;s Top White' href='/linea/product/today-fashion-casual-sleeveless-solid-womens-top-white/' />
    <link rel='next' title='Harpa Casual Short Sleeve Solid Women&#8217;s Top' href='/linea/product/harpa-casual-short-sleeve-solid-womens-top/' />
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <link type="text/css" rel="stylesheet" href="<%=PriceMe.WebConfig.CssJsPath %>/Content/print.css?ver=<%=PriceMe.WebConfig.WEB_cssVersion %>" media="print">
    <link type="text/css" rel="stylesheet" href="<%=PriceMe.WebConfig.CssJsPath %>/Content/magnific-popup.css" />
    <script type="text/javascript" src="<%=PriceMe.WebConfig.CssJsPath %>/Scripts/jquery.magnific-popup.min.js"></script>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12 col-xs-12">
                    <div class="col-main">
                        <uc1:ProductContent runat="server" ID="ProductContent" />
                        <!--product-view-->
                    </div>
                    <!--col-main-->
                </div>
...
<asp:Content ID="Content4" ContentPlaceHolderID="foot" runat="server">
    <script type='text/javascript'>
                /* <![CDATA[ */
                var wc_add_to_cart_params = { "ajax_url": "\/linea\/wp-admin\/admin-ajax.php", "wc_ajax_url": "\/linea\/product\/today-fashion-casual-sleeveless-solid-womens-top-light-pink\/?wc-ajax=%%endpoint%%", "i18n_view_cart": "View Cart", "cart_url": "http:\/\/wordpress.magikthemes.com\/linea\/cart\/", "is_cart": "", "cart_redirect_after_add": "no" };
/* ]]> */
    </script>
