...
function on_clickOutRetailer(rid, countryID, redirect) {
    var url = "/ResponseRedirect.aspx?pid=&rid=" + rid + "&rpid=&t=r" + "&countryID=" + countryID;
...
function on_clickOut(ordid, pid, rid, rpid, pname, catId, price, other, countryId, redirect, useGoogleTrackConversion) {
    var url = "/ResponseRedirect.aspx?pid=" + pid + "&rid=" + rid + "&rpid=" + rpid + "&countryID=" + countryId + "&cid=" + catId + other;
    //alert(url);
    if (redirect == 'True') {
