...
namespace PriceMeDBA{
	public partial class PriceMeDBDB{
        ...
        public StoredProcedure csk_store_CreateSitemap2(){
            StoredProcedure sp=new StoredProcedure("csk_store_CreateSitemap2",this.Provider);
            return sp;
        }
        ...
        public StoredProcedure DeleteFaceBookUserByID(){
            StoredProcedure sp=new StoredProcedure("DeleteFaceBookUserByID",this.Provider);
            return sp;
        }
        ...
        public StoredProcedure DeleteUserByEmail(){
            StoredProcedure sp=new StoredProcedure("DeleteUserByEmail",this.Provider);
            return sp;
        }
