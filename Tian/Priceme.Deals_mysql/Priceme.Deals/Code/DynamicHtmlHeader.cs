...
public static class DynamicHtmlHeader
{
    public static void SetHtmlHeader(string keyword, string description,Page page)
    {
        ...
        if (page.Request.RawUrl.Contains("EmailFriend") || page.Request.RawUrl.ToLower().Contains("login") || page.Request.RawUrl.ToLower().Contains("retailerproductalert") || page.Request.RawUrl.ToLower().Contains("410")
            ...
            || page.Request.RawUrl.ToLower().Contains("register") || page.Request.RawUrl.ToLower().Contains("reportlocation") || page.Request.RawUrl.ToLower().Contains("dealpostback")
    ...
    public static void SetFaceBookHeader(string title, string type, string imageURL, string url, Page page)
    {
    ...
    public static void SetFaceBookHeaderForVideo(string pid, string description,string imageUrl, Page page)
    {
        HtmlMeta mateFBvideo = new HtmlMeta();
        mateFBvideo.Attributes.Add("property", "og:video");
        mateFBvideo.Content = "http://api.treepodia.com/video/compact.swf?video_url=http://api.treepodia.com/video/get/"+PriceMe.WebConfig.UUID +"/"+pid;
        page.Header.Controls.Add(mateFBvideo);

        HtmlMeta mateFBogdes = new HtmlMeta();
        mateFBogdes.Attributes.Add("property", "og:description");
        mateFBogdes.Content = description;
        page.Header.Controls.Add(mateFBogdes);

        HtmlMeta mateFBdes = new HtmlMeta();
        mateFBdes.Attributes.Add("name", "description");
        mateFBdes.Content = description;
    ...
    public static void SetFaceBookHeaderForVideoDes(string pid,string pName,string pDescription,string imageUrl ,string type,Page page)
    {
        ...
        mateFBcontentURL.Content = "http://api.treepodia.com/video/get/" + PriceMe.WebConfig.UUID + "/" + pid;
        ...
        mateFBembedURL.Content = "http://api.treepodia.com/video/compact.swf?video_url=http://api.treepodia.com/video/get/" + PriceMe.WebConfig.UUID + "/" + pid;
