...
namespace PriceMeDBA
{
    public partial class PriceMeDBDB : IQuerySurface
    {
        ...
        public Query<CSK_Store_ExpertReviewAU_back> CSK_Store_ExpertReviewAU_backs { get; set; }
        ...
        public Query<Delete_PriceHistoryID> Delete_PriceHistoryIDs { get; set; }
        ...
        public Query<CSK_Store_PaymentOption> CSK_Store_PaymentOption { get; set; }
        ...
        void Init()
        {
            ...
            CSK_Store_ExpertReviewAU_backs = new Query<CSK_Store_ExpertReviewAU_back>(provider);
            ...
            Delete_PriceHistoryIDs = new Query<Delete_PriceHistoryID>(provider);
            ...
            if (DataProvider.Schema.Tables.Count == 0)
            {
                ...
                DataProvider.Schema.Tables.Add(new CSK_Store_ExpertReviewAU_backTable(DataProvider));
                ...
                DataProvider.Schema.Tables.Add(new Delete_PriceHistoryIDTable(DataProvider));
