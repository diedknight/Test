...
namespace PriceMeCommon.BusinessLogic
{
    public static class MobilePlanController
    {
        ...
        public static void Load(Timer.DKTimer dkTimer)
        {
            ...
            GetPhoneAndPlanMaps();
            BusinessLogic.LogController.WriteLog("MobilePhoneAndPlanMaps Count : " + phoneandplanmaps.Count);
            
            GetMobilePlanCarriers();
            GetAllMobilePlans();
            GetProfiles();
            BusinessLogic.LogController.WriteLog("MobilePlanList Count : " + MobilePlanList.Count);
