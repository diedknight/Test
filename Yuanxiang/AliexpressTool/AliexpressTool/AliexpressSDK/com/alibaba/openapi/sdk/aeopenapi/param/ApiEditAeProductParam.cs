...
public class ApiEditAeProductParam {
...
其中"attrNameId","attrValueId"为整型(Integer), "attrName", "attrValue"为字符串类型(String)。
    ...
    */
    ...
    public void setCouponEndDate(DateTime couponEndDate) {
        ...
        [DataMember(Order = 31)]
    private AlibabaproductAeopAEMultimedia aeopAEMultimedia;
    
        /**
       * @return 商品的多媒体信息。
    */
        public AlibabaproductAeopAEMultimedia getAeopAEMultimedia() {
               	return aeopAEMultimedia;
            }
    
    /**
     * 设置商品的多媒体信息。     *
     * 参数示例：<pre>[ { "aliMemberId": 1006680305, "mediaId": 12345678, "mediaType": "approved", "mediaStatus": "approved", "posterUrl": "http://img01.taobaocdn.com/bao/uploaded/TB1rNdGIVXXXXbTXFXXXXXXXXXX.jpg" } ]</pre>     
             * 此参数必填
          */
    public void setAeopAEMultimedia(AlibabaproductAeopAEMultimedia aeopAEMultimedia) {
