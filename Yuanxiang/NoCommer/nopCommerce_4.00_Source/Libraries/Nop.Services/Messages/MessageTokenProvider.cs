...
namespace Nop.Services.Messages
{
    ...
    public partial class MessageTokenProvider : IMessageTokenProvider
    {
        ...
        protected virtual string ProductListToHtmlTable(Order order, int languageId, int vendorId)
        {
            ...
            Dictionary<int, string> dicDeli = GetDeliverytime();
            ...
            sb.AppendLine($"<th>{_localizationService.GetResource("Messages.Order.Product(s).Delivery time", languageId)}</th>");
            ...
            for (var i = 0; i <= table.Count - 1; i++)
            {
                ...
                //Delivery time
                int DeliveryDateId = product.DeliveryDateId;
                string Deliverytime = "";
                if (dicDeli.ContainsKey(DeliveryDateId))
                    Deliverytime = dicDeli[DeliveryDateId];

                sb.AppendLine("<td style=\"padding: 0.6em 0.4em;text-align: left;\">" + WebUtility.HtmlEncode(Deliverytime));
            ...
            if (vendorId == 0)
            {
                ...
                {
                    sb.AppendLine("<tr><td style=\"text-align:right;\" colspan=\"1\">&nbsp;</td><td>&nbsp;</td><td colspan=\"3\" style=\"text-align:right\">");
        ...
        private Dictionary<int, string> GetDeliverytime()
        {
            Dictionary<int, string> dicDeli = new Dictionary<int, string>();
            string sql = "Select Id, Name from dbo.DeliveryDate";
            string connectionString = "Data Source=.;Initial Catalog=Shop_NZ;User ID=admini;Password=Q@iceM720140612;";
            using (System.Data.SqlClient.SqlConnection sqlConn = new System.Data.SqlClient.SqlConnection(connectionString))
            {
                ...
                using (System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand())
                {
                    ...
                    while (dr.Read())
                    {
                        ...
                        if (!dicDeli.ContainsKey(id))
                            dicDeli.Add(id, dr["Name"].ToString());
                    }
                    dr.Close();
                }
                sqlConn.Close();
        ...
        protected virtual void WriteTotals(Order order, Language language, StringBuilder sb)
        {
            ...
            if (displayPaymentMethodFee)
            {
                ...
                sb.AppendLine($"<tr style=\"text-align:right;\"><td>&nbsp;</td><td>&nbsp;</td><td colspan=\"2\" style=\"background-color: {_templatesSettings.Color3};padding:0.6em 0.4 em;\"><strong>{paymentMethodFeeTitle}</strong></td> <td style=\"background-color: {_templatesSettings.Color3};padding:0.6em 0.4 em;\"><strong>{cusPaymentMethodAdditionalFee}</strong></td></tr>");
            }
            ...
            foreach (var gcuh in gcuhC)
            {
                ...
                var giftCardAmount = _priceFormatter.FormatPrice(-(_currencyService.ConvertCurrency(gcuh.UsedValue, order.CurrencyRate)), true, order.CustomerCurrencyCode,
                    false, language);
                sb.AppendLine($"<tr style=\"text-align:right;\"><td>&nbsp;</td><td>&nbsp;</td><td colspan=\"2\" style=\"background-color: {_templatesSettings.Color3};padding:0.6em 0.4 em;\"><strong>{giftCardText}</strong></td> <td style=\"background-color: {_templatesSettings.Color3};padding:0.6em 0.4 em;\"><strong>{giftCardAmount}</strong></td></tr>");
            }
            ...
            if (order.RedeemedRewardPointsEntry != null)
            {
                ...
                sb.AppendLine($"<tr style=\"text-align:right;\"><td>&nbsp;</td><td>&nbsp;</td><td colspan=\"2\" style=\"background-color: {_templatesSettings.Color3};padding:0.6em 0.4 em;\"><strong>{rpTitle}</strong></td> <td style=\"background-color: {_templatesSettings.Color3};padding:0.6em 0.4 em;\"><strong>{rpAmount}</strong></td></tr>");
            }
