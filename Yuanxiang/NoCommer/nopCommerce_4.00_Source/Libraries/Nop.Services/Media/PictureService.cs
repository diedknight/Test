...
namespace Nop.Services.Media
{
    ...
    public partial class PictureService : IPictureService
    {
        ...
        protected virtual string GetThumbUrl(string thumbFileName, string storeLocation = null)
        {
            ...
            var url = "https://cdn.shop.co.nz/images/thumbs/";
        ...
        protected virtual bool GeneratedThumbExists(string thumbFilePath, string thumbFileName)
        {
            ...
            //string s3url = "https://cdn.shop.co.nz/images/thumbs/" + thumbFileName;
            //bool IsExist = false;

            //HttpWebRequest request = (HttpWebRequest)WebRequest.Create(new Uri(s3url));
        ...
        protected virtual void SaveThumb(string thumbFilePath, string thumbFileName, string mimeType, byte[] binary)
        {
            ...
            AWSS3.UploadImageExecute(thumbFilePath);
            ...
            string storeLocation = null)
        {
            ...
            else
            {
                ...
                if (string.IsNullOrEmpty(thumbFilePath))
                    return "https://cdn.shop.co.nz/images/thumbs/default-image.png";
